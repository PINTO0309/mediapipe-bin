...
curl -sc /tmp/cookie "https://drive.google.com/uc?export=download&id=12EFxyDmqaKBLK_tnFXrcphKNHRBat3MP" > /dev/null
CODE="$(awk '/_warning_/ {print $NF}' /tmp/cookie)"
curl -Lb /tmp/cookie "https://drive.google.com/uc?export=download&confirm=${CODE}&id=12EFxyDmqaKBLK_tnFXrcphKNHRBat3MP" -o mediapipe-0.8.5_cuda102-cp36-none-linux_aarch64.whl
