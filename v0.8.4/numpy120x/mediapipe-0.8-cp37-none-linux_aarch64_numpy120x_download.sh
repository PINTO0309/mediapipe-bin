...
CODE="$(awk '/_warning_/ {print $NF}' /tmp/cookie)"
curl -Lb /tmp/cookie "https://drive.google.com/uc?export=download&confirm=${CODE}&id=1qrAtG7FB3SFUKzll817d4P_tuzSQCItE" -o opencv_contrib_python-4.5.2.52-cp37-cp37m-linux_aarch64.whl
